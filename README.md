...
* Airbnb hosts could act as potential centres in distributed care networks (particularly in care deserts or recovery-focused housing).  This could include temporary home care environments offering specialised accommodation for guests who require in-home nursing while away from home or a rental near their treatment centre (e.g., for palliative care, rehab or surgeries). 
